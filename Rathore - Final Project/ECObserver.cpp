...
void ECKeyboardObserver::Update()
{
    ...
    //}
        ...
        //  && controller.GetMode() == 0)
    if (evt == ECGV_EV_KEY_UP_F) { // up for fill
        //controller.SetMode();
        controller.FillShapes();
    }
    ...
    if (evt == ECGV_EV_KEY_UP_UP && controller.GetMode() == 0) {
        controller.MoveByArrow(1);
    }

    if (evt == ECGV_EV_KEY_UP_DOWN && controller.GetMode() == 0) {
        controller.MoveByArrow(4);
    }

    if (evt == ECGV_EV_KEY_UP_LEFT && controller.GetMode() == 0) {
        controller.MoveByArrow(2);
    }

    if (evt == ECGV_EV_KEY_UP_RIGHT && controller.GetMode() == 0) {
